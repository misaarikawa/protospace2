class PrototypesController < ApplicationController
  ...
  def prototype_params
    params.require(:prototype).permit(:title, :catch_copy, :concept, :tag_list, prototype_images_attributes: [:id, :content, :status, :_destroy]).merge(user_id: current_user.id)
  end
